...
- The map function takes a function and a list, and applies that function to ev-
  ery element in the list, producing a new list
...
As another example, let’s find the largest num-
ber under 100,000 that’s divisible by 3,829
...
ambdas are anonymous functions
...
Creating the `elem` function with `foldr`
...
plies that function to 3.

## Function composition

In mathematics, function composition is defined like this: (f o g)(x) = f (g(x)).
